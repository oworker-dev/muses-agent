...
/**
 * Renders an Eve-projected text part outside MessagePrimitive's part scope.
 * The regular MarkdownText remains the assistant-ui primitive renderer; this
 * adapter keeps the same registry styles for the durable task projection.
 */
export function StaticMarkdownText({ text }: { readonly text: string }) {
  return (
