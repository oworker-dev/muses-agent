...
import { AtSignIcon, CheckIcon, ChevronDownIcon, CommandIcon, FileIcon, PlusIcon, ShieldCheckIcon, XIcon, } from "lucide-react";
...
export function AgentComposer({ commands = [], disabled = false, inputDisabled = false, mentions = [], messages, models, onPreferencesChange, onSubmit, onStop, preferences, reasoningLevels, status, usage, }) {
    ...
    return (_jsxs(PromptInput, { className: "relative overflow-visible border-border bg-card shadow-[0_12px_36px_-20px_rgba(0,0,0,0.28)]", maxFileSize: 10 * 1024 * 1024, multiple: true, onSubmit: (message) => {
        ...
        }, children: [attachments.files.length > 0 ? (_jsx(PromptInputHeader, { children: _jsx(ComposerAttachments, { messages: messages }) })) : null, _jsx(ComposerTextarea, { commands: commands, disabled: disabled || inputDisabled, mentions: mentions, messages: messages }), _jsxs(PromptInputFooter, { className: "min-h-10 gap-1.5 px-2.5 pb-2.5", children: [_jsxs(PromptInputTools, { className: "min-w-0 flex-1 gap-0.5", children: [_jsxs(PromptInputActionMenu, { children: [_jsx(PromptInputActionMenuTrigger, { "aria-label": messages.addFiles, tooltip: messages.addFiles, children: _jsx(PlusIcon, { className: "size-4" }) }), _jsxs(PromptInputActionMenuContent, { align: "start", side: "top", children: [_jsx(PromptInputActionAddAttachments, { label: messages.addFiles }), _jsx(PromptInputActionAddScreenshot, { label: messages.takeScreenshot })] })] }), _jsx(ExecutionModeSelect, { label: messages.executionMode, onChange: (nextMode) => onPreferencesChange({ ...preferences, executionMode: nextMode }), value: executionMode })] }), _jsxs("div", { className: "ml-auto flex min-w-0 shrink items-center justify-end gap-0.5", children: [_jsx(ModelSelect, { label: messages.model, messages: messages, models: models, onChange: (modelId) => onPreferencesChange({ ...preferences, modelId }), value: preferences.modelId }), _jsx(ReasoningSelect, { label: messages.reasoning, onChange: (reasoning) => onPreferencesChange({ ...preferences, reasoning }), reasoningLevels: reasoningLevels, value: preferences.reasoning }), _jsx(ContextUsage, { messages: messages, models: models, modelId: preferences.modelId, usage: usage }), _jsx(PromptInputSubmit, { "aria-label": status === "ready" || status === "error" ? messages.send : messages.cancel, className: "static size-8", disabled: disabled, onStop: onStop, status: status })] })] })] }));
}
