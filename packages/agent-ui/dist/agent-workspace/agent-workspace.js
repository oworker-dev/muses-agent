...
export function AgentWorkspace({ agentName = "muses-agent", client, commands = [], defaultPreferences, extensions = [], hostSlots, models, mentions = [], onEvent, onDeleteThread, onStorageError, productName = "Agent", reasoningLevels, runtimeStatus = { provider: "ready" }, storageKey = DEFAULT_STORAGE_KEY, threadStorage = browserThreadStorage, }) {
