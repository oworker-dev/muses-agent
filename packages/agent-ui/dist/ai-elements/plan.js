...
export const Plan = ({ className, isStreaming = false, children, ...props }) => {
    ...
    return (_jsx(PlanContext.Provider, { value: contextValue, children: _jsx(Collapsible, { asChild: true, "data-slot": "plan", ...props, children: _jsx(Card, { className: cn("shadow-none", className), children: children }) }) }));
};
