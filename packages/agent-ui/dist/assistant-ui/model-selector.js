...
function ModelSelectorContent({ className, align = "start", effortLabel, side, sideOffset = 6, searchable, children, ...props }) {
    ...
    return (_jsx(PopoverContent, { ref: popupRef, "data-slot": "model-selector-content", align: align, side: renderedSide ?? side ?? "bottom", sideOffset: sideOffset, className: cn("bg-popover/95 w-72 min-w-(--radix-popover-trigger-width) overflow-hidden rounded-xl p-0 shadow-lg backdrop-blur-sm", className), ...props, children: _jsxs(Command, { className: "bg-transparent", shouldFilter: !unfiltered, ...(value !== undefined ? { defaultValue: value } : {}), children: [unfiltered && _jsx(ModelSelectorFocusAnchor, {}), children ?? (_jsxs(_Fragment, { children: [searchable && _jsx(ModelSelectorSearch, {}), _jsx(ModelSelectorList, {}), _jsx(ModelSelectorEffort, { label: effortLabel })] }))] }) }));
}
